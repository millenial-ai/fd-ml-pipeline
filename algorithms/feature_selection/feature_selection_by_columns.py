...
"""
def select_features_by_columns(input_path, output_path, selected_features=[]):
...
if __name__ == "__main__":
    ...
    select_features_by_columns(args.input_data, args.output_data, args.selected_features.split(","))
